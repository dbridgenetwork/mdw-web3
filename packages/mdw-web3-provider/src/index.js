/*
    This file is part of mdw-web3.js.
    mdw-web3.js is free software: you can redistribute it and/or modify
...
*/
/**
 * @author dbridge.network <admin@dbridge.network>
 * @date 2023
 */
      ...
      try {
        ...
        if (result.result && result.result.redirect) {
          if (!_this.window || _this.window.closed) {
            _this.window = window.open(
              result.result.redirect,
              'Connect application to MyDappShop',
